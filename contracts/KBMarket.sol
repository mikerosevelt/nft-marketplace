...
contract KBMarket is ReentrancyGuard {
    ...
    // keep tracks of tokens total number - tokenId
    ...
    function makeMarketItem(
        ...
        // putting it up for same - bool - no owner
    ...
    function fetchMarketTokens() public view returns (MarketToken[] memory) {
        ...
        // looping over the number of items created (if number has not been sold populated the )
    ...
    function fetchMyNTFs() public view returns (MarketToken[] memory) {
